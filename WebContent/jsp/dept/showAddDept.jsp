...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${pageContext.request.contextPath }/add.dept" id="deptForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">部门名称：<input type="text" name="deptName" id="deptName" value="${param.deptName }" size="20"/></td>
		    			<td class="font3 fftd">详细描述：<input type="text" name="deptDesc" id="deptDesc" value="${param.deptDesc }" size="20"/></td>
		    		</tr>
